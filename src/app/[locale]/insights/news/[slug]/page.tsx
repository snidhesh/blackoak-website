...
export default async function NewsDetailPage({ params }: Props) {
  ...
  const formattedDate = formatDate(article.publishedDate, locale);
    ...
    <>
        ...
        <div className="max-w-[1094px] mx-auto px-6">
          <div className="flex flex-col md:flex-row items-start md:items-start justify-between gap-10">
            ...
            <div className="flex flex-col gap-[27px]">
              <p className="text-[18px] font-normal text-black opacity-60">{tCommon('tags')}</p>
            ...
            {/* Share */}
            <div className="flex flex-col gap-[27px]">
              <p className="text-[18px] font-normal text-black opacity-60">{tCommon('share')}</p>
      ...
      <section className="pb-20">
        <div className="container-narrow text-center mb-12">
          <AnimateOnScroll>
            <SectionLabel>{t('relatedNewsLabel')}</SectionLabel>
            <SectionHeading
              title={t('relatedNewsHeading')}
