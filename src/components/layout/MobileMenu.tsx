...
const socialLinks = [
  {
    platform: 'facebook',
    url: 'https://www.facebook.com/BlackOakRealEstate/',
    icon: (
  ...
  {
    platform: 'linkedin',
    url: 'https://ae.linkedin.com/company/blackoak-real-estate',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
  ...
  {
    platform: 'instagram',
    url: 'https://www.instagram.com/blackoakdubai/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
  ...
  {
    platform: 'tiktok',
    url: 'https://www.tiktok.com/@blackoak.realestate',
    icon: (
  ...
  {
    platform: 'youtube',
    url: 'https://www.youtube.com/@blackoakrealestate',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
...
export default function MobileMenu({ isOpen, onClose, navigation }: MobileMenuProps) {
  ...
  const secondaryLinks = [
    { label: t('mobileSecondaryLinks.listYourProperty'), href: '/list-your-property' },
    { label: t('mobileSecondaryLinks.career'), href: '/career' },
    { label: t('mobileSecondaryLinks.contact'), href: '/contact' },
  ];
                ...
                <>
                  ...
                  <div
                    className={cn(
                      ...
                      expandedItems.includes(getNavKey(item))
